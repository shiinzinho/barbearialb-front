...
<Link to={"/RecuperarSenhaProfissional/" + usuario.id} className='btn btn-dark btn-sm m-1'><svg xmlns="http://www.w3.org/2000/svg" width="19" height="20" fill="currentColor" className="bi bi-bootstrap-reboot" viewBox="0 0 16 16">
